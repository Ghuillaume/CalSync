...
\chapter{Conception de l'interface utilisateur}
    ...
    \section{Menus principaux}
        ...
        \begin{itemize}
            ...
            \item Edit :
                \begin{itemize}
                    \item[\bullet] Create an event
                \end{itemize}
            \item Synchronization :
                \begin{itemize}
                    \item[\bullet] Reset local calendar with my Google Calendar
                    \item[\bullet] Update local calendar from UnivNantes (CELCAT)
                    \item[\bullet] Save my calendar on Google Calendar
                    \item[\bullet] Settings
                \end{itemize}
        \end{itemize}
